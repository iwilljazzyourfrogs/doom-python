...
class SpriteObj:
    def __init__(self, game, pos, path, scale=1.0, shift=0.0):
        self.game = game
    ...
    def get_sprite_projection(self):
        ...
        self.game.raycasting.objs_to_render.append((self.norm_dist, image, pos))
...
class AnimatedSprite(SpriteObj):
    def __init__(self, game, pos, path="resources/sprites/animated_sprites/green_light/0.png", scale=1.0, shift=0.0, anim_time=90):
